    ...
    <div class="field col-12">
        ...
        <div class="flex items-center">
            <FileUpload
                ...
                :pt="{
                    root: { class: 'border-1 surface-border surface-card border-round mb-4' },
                    buttonbar: { class: 'hidden' },
                    removeButton: { class: '' }
                }"
            >
                <template #content>
                    <div v-if="selectedFile" class="w-full py-3" style="min-width: 250px;">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="50px" width="50px" version="1.1" id="Layer_1" viewBox="0 0 303.188 303.188" xml:space="preserve">
                                <g>
                            ...
                            <Button
                                icon="pi pi-times"
                                class="p-2 remove-button text-sm absolute justify-content-center align-items-center cursor-pointer"
                                @click="onRemoveFile()"
                            >
                                Διαγραφή
                            </Button>
                ...
                <template #empty>
                    <div v-if="!selectedFile" @click="onChooseUploadFiles" class="w-full py-3 bg-grey-200" :style="{ cursor: 'copy' }">
                        <div class="h-full flex flex-column justify-content-center align-items-center">
                            <i class="pi pi-upload text-900 text-2xl mb-3"></i>
                            <span class="font-bold text-900 text-md mb-3">Επιλογή Βιογραφικού Σημειώματος (CV)</span>
                        </div>
                    </div>
                </template>
            </FileUpload>
