...
<template>
    <div class="field col-12">
        ...
        <FileUpload @select="onSelectedFiles" mode="basic" accept="application/pdf" :maxFileSize="1000000" chooseLabel="Επιλογή Βιογραφικού" class="mr-2 inline-block" />
        ...
        <!-- <div class="flex items-center">
            ...
            >
                <template #content>
                    <div v-if="selectedFile" class="w-full" style="min-width: 250px;">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="75px" width="75px" version="1.1" id="Layer_1" viewBox="0 0 303.188 303.188" xml:space="preserve">
                                <g>
