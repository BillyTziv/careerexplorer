...
function openHollandTest() {
    router.visit('/tests/holland/start');
}

const faq = ref([
    {
        question: 'Πόσο χρόνο διαρκεί το τεστ επαγγελματικού προσανατολισμού;',
        answer: 'Το τεστ διαρκεί περίπου 5-10 λεπτά και αποτελείται από ερωτήσεις πολλαπλών επιλογών που αναλύουν τις προτιμήσεις σας και τις επαγγελματικές σας δεξιότητες.'
    },
    {
        question: 'Ποια είναι τα οφέλη από τη χρήση του τεστ επαγγελματικού προσανατολισμού;',
        answer: 'Το τεστ σας βοηθά να εντοπίσετε τις επαγγελματικές σας δυνατότητες και να ανακαλύψετε καριέρες που ταιριάζουν στις ικανότητες και τα ενδιαφέροντά σας, προσφέροντας σας έναν ξεκάθαρο προσανατολισμό για το μέλλον.'
    },
    {
        question: 'Πόσο αξιόπιστα είναι τα αποτελέσματα του τεστ;',
        answer: 'Τα αποτελέσματα του τεστ βασίζονται σε επιστημονικά αναγνωρισμένες μεθόδους και εργαλεία, προσφέροντας αξιόπιστα προφίλ για τις επαγγελματικές δυνατότητες του κάθε ατόμου.'
    },
    {
        question: 'Πώς θα με βοηθήσει το τεστ να επιλέξω καριέρα;',
        answer: 'Το τεστ αναλύει τα προσωπικά σας χαρακτηριστικά και σας παρέχει αναλυτικές προτάσεις καριέρας που ταιριάζουν στις δεξιότητές σας, βοηθώντας σας να λάβετε τεκμηριωμένες αποφάσεις για την επαγγελματική σας πορεία.'
    },
    {
        question: 'Τι είναι το τεστ επαγγελματικού προσανατολισμού;',
        answer: 'Το τεστ επαγγελματικού προσανατολισμού είναι μια σειρά από ψυχομετρικές ερωτήσεις που βοηθούν στην ανάλυση των ικανοτήτων, ενδιαφερόντων και δεξιοτήτων σας, ώστε να σας προτείνουν την πιο κατάλληλη καριέρα για εσάς.'
    }
]);
</script>
            ...
            <div class="py-4 px-4 mx-0 md:mx-6 lg:mx-8 lg:px-8 z-2">
                <div id="home" class="grid grid-nogutter justify-content-between align-items-center mb-6 py-6 md:mb-8 md:py-8">
                    <div class="col-12 md:col-4 flex flex-column gap-4 flex-order-1 md:flex-order-0 align-items-center md:align-items-start text-center md:text-left">
                        <span class="block text-900 font-bold text-4xl">
                            Τεστ Επαγγελματικού Προσανατολισμού - Το πρώτο βήμα για την καριέρα σου
                        </span>
                        <span class="block text-700 text-lg">
                            Ανακάλυψε τις δυνατότητές σου σε ελάχιστα λεπτά
                        </span>
                        <ul class="flex flex-wrap gap-5 list-none p-0">
                            <li class="flex align-items-center">
                                <div class="p-1 border-circle bg-green-400 inline-block mr-2"></div>
                                <span class="text-900 font-semibold">Αξιόποιστο</span>
                            </li>
                            <li class="flex align-items-center">
                                <div class="p-1 border-circle bg-green-400 inline-block mr-2"></div>
                                <span class="text-900 font-semibold">Εύκολο</span>
                            </li>
                            <li class="flex align-items-center">
                                <div class="p-1 border-circle bg-green-400 inline-block mr-2"></div>
                                <span class="text-900 font-semibold">Πρωτοπόρο</span>
                            </li>
                        </ul>
                        <Button @click="openHollandTest" type="button" label="Ξεκίνα το τεστ" icon="pi pi-arrow-right" iconPos="right" class="w-12rem" outlined></Button>
                    </div>
                ...
                <div id="features" class="my-6 py-6 md:my-8 md:py-8">
                    <span class="text-900 block font-bold text-5xl mb-4 text-center">Συχνές Ερωτήσεις</span>
                   
                    <span class="text-700 block text-xl mb-8 text-center line-height-3  mt-8">
                        Αν έχεις αμφιβολία για κάτι, μπορεί να βρεις την απάντηση σου παρακάτω.
                    </span>

                    <div class="card flex-1">
                        <Accordion>
                            <AccordionTab v-for="(item, i) in faq" :key="i" :header="item.question">
