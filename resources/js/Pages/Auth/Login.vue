...
<template>
    ...
    <div class="px-5 min-h-screen flex justify-content-center align-items-center">
        <div class="border-1 surface-border surface-card border-round py-7 px-4 md:px-7 z-1">
            <div class="mb-4">
                <div class="text-900 text-xl font-bold mb-2">CareerExplorer</div>
                <span class="text-600 font-medium">Explore new opportunities</span>
            </div>
            <div class="flex flex-column">
               
                    <IconField iconPosition="left" class="w-full mb-4">
                        <InputIcon class="pi pi-envelope" />
                        <InputText v-model="form.email" type="text" class="w-full md:w-25rem" placeholder="Email" />
                    </IconField>

                    <IconField iconPosition="left" class="w-full mb-4">
                        <InputIcon class="pi pi-lock" />
                        <InputText v-model="form.password" type="password" class="w-full md:w-25rem" placeholder="Password" />
                    </IconField>
                    ...
                    <Button @click="submit" label="Log In" class="w-full"></Button>
