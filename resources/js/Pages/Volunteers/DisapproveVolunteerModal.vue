            ...
            <div class="relative w-full max-w-2xl max-h-full z-10">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 space-y-6">
                        <span class="text-white">Σημειώστε τον λόγο απόρριψης:</span>
                        <BaseInput
                            v-model="reason"
                            accessKey="name"
                            label="Λόγος"
                    ...
                    <!-- Modal footer -->
                    <div v-if="reason.length > 3" class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                        <button
                            @click="disapproveVolunteer"
...
<script setup>
    ...
    const emit = defineEmits(['update:isOpen', 'disapprove']);
    ...
    function disapproveVolunteer() {
        emit('disapprove', reason.value );
        emit('update:isOpen', false);
    }
</script>