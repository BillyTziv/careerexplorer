<script setup>
    ...
    const redirectToCreate = () => {    
        router.visit(`/career-interests/create`);
    };


    // Export the interest table to CSV
    const exportCareerInterestsAsCSV = () => {
    ...
    <AppPageWrapper>
        ...
        <template #page-content>
            <div class="flex flex-column align-items-center md:flex-row md:align-items-start md:justify-content-between mb-3">
                ...
                <div class="flex">
                    <Button type="button" icon="pi pi-download" rounded v-tooltip="'Export Data'" text @click="exportCareerInterestsAsCSV"></Button>
